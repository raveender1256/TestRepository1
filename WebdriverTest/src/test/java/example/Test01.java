...
public class Test01 {
	...
	public void BeforeTest(){   	   		 	
		...
		System.out.println("BeforeTest methos executed and launched the chromebrowser sucesssfully");
	}
   ...
   // Test1:
	...
	//Test5: find element AND find elements
		 ...
		 * //expliWait.until(ExpectedConditions.titleContains(driver.getTitle()));
		 * 
		 * expliWait.until(ExpectedConditions.visibilityOfElementLocated(By.
		 * linkText("Demo Site")));
		 * 
		 * driver.findElement(By.id("no")).click(); Thread.sleep(3000);
	...
	//Test6 :
		 ...
		 * driver.findElement(By.xpath("//p[@class='submit']//span[1]")).click(); // by
		 * submitting the SignIN button
		 * //--driver.findElement(By.xpath("//p[@class='submit']//span[1]")).submit();
		 * 
		 * // by using submit method on Username field webelement
		 * //--driver.findElement(By.xpath("//input[@id='passwd']")).submit(); // by
		 * using submit method on password field webelement
	...
	//test7:
		 ...
		 * System.out.println("Number of checkboxes: "+ ChkboxElements.size()); 
		 * for(int i = 0;i< ChkboxElements.size();i++) {
		 * 
	...
	//Test9:  Selecting LOV 
		...
		webEcountry.selectByVisibleText("INDIA");
		Thread.sleep(3000);		
		driver.findElement(By.xpath("//input[@name='submit']")).click();
		Thread.sleep(3000);
		if(driver.findElement(By.xpath("//b[contains(text(),'Dear')]")).isDisplayed()) {
			System.out.println("Pass");			
			System.out.println(driver.findElement(By.xpath("//font[contains(text(),'Thank you for registering. ')]")).getText());			
		}
	*/
